...
|---|---|
| [docs/guide/](docs/guide/README.en.md) | **Integration Guide** — install, embed, API ([Korean](docs/guide/README.md)) + [Designer Guide](docs/guide/designer.en.md) (screenshots) · [Formula Functions](docs/guide/formula.en.md) · [Type Reference](docs/guide/types.en.md) · [Fonts & Presets](docs/guide/fonts-and-presets.en.md) |
