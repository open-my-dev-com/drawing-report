...
- **필요한지 애매하면 임의로 정하지 말고 사용자에게 묻는다** (2026-08-21 지정). 넣을지 뺄지로
  화면이 달라지는 판단은 물어보고 정한다.
