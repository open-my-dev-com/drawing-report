...
const ko = {
  ...
  designer: {
    ...
    /* 그림 올리기 (G-36) — 올린 파일을 base64로 담는다. 주소 입력은 두지 않는다 */
    imageModalTitle: '그림 고르기',
    imagePick: '파일에서 고르기',
    imageReuse: '이미 넣은 그림',
    imageNone: '아직 그림을 고르지 않았습니다',
    imageSizeHint: '{max}까지 넣을 수 있습니다. 넣은 그림은 양식 파일 안에 함께 담깁니다',
    imageEmptyReuse: '이 양식에 넣어 둔 그림이 없습니다',
    imageChange: '그림 바꾸기',
    imageTooLarge: '그림이 너무 큽니다 — {max}까지 넣을 수 있습니다 (고른 파일 {size})',
    imageNotImage: '그림 파일이 아닙니다',
    imageReadFailed: '파일을 읽지 못했습니다',
    styleLine: '선',
    lineColor: '선 색',
    lineWidth: '선 굵기',
    lineShape: '선 모양',
...
const en: SlipStrings = {
  ...
  designer: {
    ...
    imageModalTitle: 'Choose image',
    imagePick: 'Pick a file',
    imageReuse: 'Images already added',
    imageNone: 'No image chosen yet',
    imageSizeHint: 'Up to {max}. The image is stored inside the template file.',
    imageEmptyReuse: 'No images added to this template yet',
    imageChange: 'Change image',
    imageTooLarge: 'Image is too large — up to {max} allowed (picked file is {size})',
