...
const ko = {
  ...
  designer: {
    ...
    columnWidth: '열 너비',
    overflow: '글이 칸을 넘치면',
    overflowClip: '넘는 부분 잘라내기',
    overflowShrink: '글자 줄여 넣기',
    repeatSection: '구간 반복',
    repeatOn: '반복 사용',
    repeatFrom: '시작 행',
    repeatTo: '종료 행',
    repeatPerPage: '구간의 기본 틀 생성 개수',
    repeatMaxItems: '그릴 항목 수 상한',
...
const en: SlipStrings = {
  ...
  designer: {
    ...
    overflow: 'When text overflows a cell',
    overflowClip: 'Clip the overflow',
    overflowShrink: 'Shrink text to fit',
    repeatSection: 'Repeating band',
    repeatOn: 'Repeat',
    repeatFrom: 'First row',
    repeatTo: 'Last row',
    repeatPerPage: 'Item slots per page',
    repeatMaxItems: 'Max items to draw',
...
const ja: SlipStrings = {
  ...
  designer: {
    ...
    rowHeight: '行の高さ',
    columnWidth: '列の幅',
    overflow: '文字がセルをはみ出したら',
    overflowClip: 'はみ出しを切り取る',
    overflowShrink: '文字を縮小して収める',
    repeatSection: '繰り返し範囲',
    repeatOn: '繰り返しを使う',
    repeatFrom: '開始行',
    repeatTo: '終了行',
    repeatPerPage: 'ページあたりの枠数',
    repeatMaxItems: '描画する項目数の上限',
