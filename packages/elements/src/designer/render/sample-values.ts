/**
 * 샘플 값과 수식 결과를 화면 입력값으로 바꾸거나 화면 입력값에서 읽습니다.
 *
 * @remarks
 * 샘플 값에는 별도의 타입 정보가 없으므로 입력 문자열을 분석해 숫자 여부를 판별합니다.
 */

/**
 * 숫자 형식의 샘플 입력은 숫자로, 나머지는 문자열로 반환합니다.
 *
 * @param text - 입력 문자열
...
/**
 * 스칼라 샘플 값을 입력 요소에 표시할 문자열로 변환합니다.
 *
 * @param value - 샘플 값
