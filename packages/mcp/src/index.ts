...
// PDF 링크 HTTP 서버(`./http.js`의 `createPdfLinkToken`·`startPdfLinkServer`·`startPdfLinkServerWithFallback`·
// `PdfLinkServer`)는 CLI가 서버 수명을 관리하는 구현 세부이므로 공개 API로 내보내지 않습니다.
