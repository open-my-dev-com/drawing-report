...
| 문서 | 내용 |
|---|---|
| [docs/guide/](docs/guide/) | **사용 가이드** — 설치·연동·API ([English](docs/guide/README.en.md)) + [디자이너 가이드](docs/guide/designer.md)(화면 캡처) · [수식 함수](docs/guide/formula.md) · [타입 참조](docs/guide/types.md) · [폰트·프리셋](docs/guide/fonts-and-presets.md) |
