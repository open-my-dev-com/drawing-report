...
[한국어](getting-started.ko.md) · [日本語](getting-started.ja.md)
...
- [Form Designer Guide](designer.md): how to build a template on screen
- [Core API Guide](core.md): file validation and PDF generation in Node.js
- [Formula Function Reference](formula.md): formulas you can use in a template
